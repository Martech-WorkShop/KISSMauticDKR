...
ENV MAUTIC_DB_PASSWORD=/ULk+fQiTrvRvf6SdMGwpd6uXwdCZoxn8P5+KyXoz3k=
...
COPY assets/6.0.2/mautic-6.0.2.sql /mauticdb-dump.sql
COPY assets/6.0.2/mautic-6.0.2-local.php /var/www/html/config/local.php

...
RUN wget -O /etc/php/8.2/fpm/pool.d/www.conf https://raw.github.com/Martech-WorkShop/toolBelt/Prod/Mautic/conf/fpm/www.conf
# Configuration for PHP.
RUN wget -O /etc/php/8.2/fpm/php.ini https://raw.github.com/Martech-WorkShop/toolBelt/Prod/Mautic/conf/php/php.ini
